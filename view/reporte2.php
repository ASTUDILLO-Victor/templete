...
$sql_meses = "SELECT DISTINCT DATE_FORMAT(hora_inicio, '%Y-%m') as mes FROM prom_mq138 ORDER BY mes";
...
<body>
<div class="container">
        <h1 class="mt-4">Reporte de Compuestos Orgánicos Volatiles</h1>
    ...
    <script src="scriptmes2.js"></script>
    <script>
